...
2. Mean intensity extraction from SNpc
   * sn_extraction.ipynb

3. Mean intensity extraction from putamen
   * putamen_extraction.ipynb

4. Mean intensity extraction from LC (due to frequent server crashes, LC extraction was performed in batches)
   * lc_extraction.ipynb
